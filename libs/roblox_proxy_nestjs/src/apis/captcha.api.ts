...
export class CaptchaApi {
  static readonly FunCaptchaPublicKeys = {
    ...
    ACTION_TYPE_GENERIC_CHALLENGE: "CC30DB96-0C88-4DEB-86E5-6601927ACBB4",
    ...
    ACTION_TYPE_WEB_RESET_PASSWORD: "476068BF-9607-4799-B53D-966BE98E2B81",

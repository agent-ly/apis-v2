...
export class BillingApi {
  ...
  getCreditBalance(roblosecurity: string): Promise<GetCreditBalanceResponse> {
    ...
    return this.client.json<GetCreditBalanceResponse>(url, init);
  }
  ...
  checkout(
    ...
    return this.client.json<CheckoutResponse>(url, init);
  }
  ...
  checkoutSuccess(
    ...
    const init = { method: "POST", roblosecurity, data: payload };
    return this.client.json<CheckoutSuccessResponse>(url, init);
  }
}
...
////export const CONVERT_TO_ROBUX_THRESHOLD = 4.99;
